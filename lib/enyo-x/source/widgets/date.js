...
(function () {
  ...
  enyo.kind(
    ...
    components: [
      {controlClasses: 'enyo-inline', components: [
        ...
        {name: "datePickPopup", kind: "onyx.Popup", maxHeight: 400, floating: true,
          ...
          {kind: "GTS.DatePicker", name: "datePick", style: "min-width:300px;",
            onChange: "datePicked"}
        ]}
      ]}
    ],
    ...
    */
    ...
    /**
      Stomp on input.receiveBlur to compare globalized date (input value) with model's date
      i.e. "23/09/2015", Tue Sep 22 2015 18:00:00 GMT-0600 (CST)
    */
    receiveBlur: function () {
      var value = XT.date.applyTimezoneOffset(this.getValue(), true);
      if (this.$.input.getValue() !== Globalize.format(value, "d")) {
        this.inputChanged();
      }
    },
    /**
