    ...
    transact: function (models, prompt, transFunction, transWorkspace, transQty) {
      ...
      callback = function (workspace, transFunction, transWorkspace, transQty) {
        ...
        // If a workspace brought us here, process the information it obtained
          ...
          model.modelName = workspace.model;
          ...
          if (data[0]) {
            ...
            dispOptions.success = function () {
              _.each(that._printModels, function (printModel) {
                ...
                var printer = XT.defaultPrinter(printModel.modelName),
                  printOptions = {
                    auxilliaryInfo: printModel._auxilliaryInfo
                  };
                ...
                if (printer) {
                  ...
                  printModel.doPrint(printOptions);
                } else {
                  that.openReport(XT.getOrganizationPath() + printModel.getReportUrl());
                }
              });
