...
white:true*/
/*global Backbone:true, enyo:true, XT:true, _:true, document:true, window:true, XM:true, Globalize:true */
...
(function () {
  ...
  enyo.kind(
    ...
    handlers: {
      ...
      onGenerateReport: "waterfallGenerateReport"
    },
    /*
      Three use cases:
    ...
    */
    ...
    startupProcess: function () {
      ...
      // TODO - 7. Initiate Empty Database Startup "checklist" process for empty/quick start databases
        ...
        // Set the globalize culture if not english/default
        Globalize.culture(XT.locale.language);
      }
    },
    ...
    waterfallGenerateReport: function (inSender, inEvent) {
      this.$.postbooks.waterfall("onGenerateReport", inEvent);
      return true;
    },
